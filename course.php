			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="row">
						...
						try {
							...
							if ($result->num_rows > 0) {
								...
								foreach ($rows as $row) {
									...
									$html = sprintf($template, $nameUrl, $institute, $type, $nameUrl, $name, $skills, $otherDetails, $rating);
						...
						<div class="col-md-6 d-flex align-items-stretch ftco-animate">
							<div class="project-wrap">
								<a href="#" class="img" style="background-image: url(https://companieslogo.com/img/orig/COUR_BIG-e3284ace.png);">
									<span class="price">Software</span>
								</a>
								<div class="text p-4">
									<h3><a href="#">Design for the web with adobe photoshop</a></h3>
